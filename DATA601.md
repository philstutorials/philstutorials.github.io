...
If you followed the anaconda installation instructions provided on course's D2L then for your first assignment you only need to refer to the *latest* python and matplotlib documentation:
